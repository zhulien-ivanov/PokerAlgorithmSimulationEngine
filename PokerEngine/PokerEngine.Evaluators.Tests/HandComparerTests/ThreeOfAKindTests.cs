...
namespace PokerEngine.Evaluators.Tests.HandComparerTests
{
    ...
    public class ThreeOfAKindTests
    {
        ...
        [TestMethod]
        public void Having2SameThreeOfAKindHandsWithReturnsProperResult()
        {
            var inputHand1 = new Hand
                (
                    new List<Card>()
        ...
        [TestMethod]
        public void Having4DifferentThreeOfAKindHandsWith2EqualHandsReturnsProperResult()
        {
            var inputHand1 = new Hand
                (
                    new List<Card>()
        ...
        [TestMethod]
        public void Having1ThreeOfAKindVs1TwoPairHandVs1OnePairHandvsHighCardHandReturnsProperResult()
        {
            var inputHand1 = new Hand
                (
                    new List<Card>()
        ...
        [TestMethod]
        public void Having2EqualThreeOfAKindVs1TwoPairHandVs1OnePairHandvsHighCardHandReturnsProperResult()
        {
            var inputHand1 = new Hand
                (
                    new List<Card>()
